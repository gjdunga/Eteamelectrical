...
<header class="site-header" id="site-header">
    <div class="container header-inner">
        ...
        <nav id="primary-menu" class="primary-nav">
            <ul class="menu">
                <li<?php if(basename($_SERVER['PHP_SELF'])==='index.php') echo ' class="current-menu-item"'; ?>><a href="<?php echo $base; ?>index.php">Home</a></li>
                <li<?php if(basename($_SERVER['PHP_SELF'])==='gallery.php') echo ' class="current-menu-item"'; ?>><a href="<?php echo $base; ?>gallery.php">Gallery</a></li>
                <li<?php if(basename($_SERVER['PHP_SELF'])==='reviews.php') echo ' class="current-menu-item"'; ?>><a href="<?php echo $base; ?>reviews.php">Reviews</a></li>
                <li<?php if(basename($_SERVER['PHP_SELF'])==='payment.php') echo ' class="current-menu-item"'; ?>><a href="<?php echo $base; ?>payment.php">Payment</a></li>
